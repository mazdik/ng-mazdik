...
@Component({
  ...
  template: `
    ...
    <app-modal class="rank-modal" #rankModal [modalTitle]="'Rank'" [maximizable]="true">
    ...
    <app-modal class="inventory-modal" #inventoryModal [modalTitle]="'Inventory'" [maximizable]="true">
